                        ...
                        <div class="col-12">
                            <div class="p-5">
                                ...
                                while ($rowData = mysqli_fetch_assoc($result_select_query)) {
                                    $supplier_name = $rowData['s_name'];
                                    $supplier_email = $rowData['s_email'];
                                    $supplier_uname = $rowData['s_uname'];
                                    $supplier_address = $rowData['s_add'];
                                    $supplier_id = $rowData['s_id'];

                                    echo "<div class='row-item row mb-4 d-flex justify-content-between align-items-center'>
                                        <div class='col-2'>
                                            <h6 class='text-black mb-0'>$supplier_name</h6>
                                        </div>
                                        <div class='col-3'>
                                            <h6 class='text-black mb-0'>$supplier_email</h6>
                                        </div>
                                        <div class='col-2'>
                                            <h6 class='text-black mb-0'>$supplier_uname</h6>
                                        </div>
                                        <div class='col-4'>
                                            <h6 class='text-black mb-0'>$supplier_address</h6>
                                        </div>
                                        <div class='col-1 d-flex justify-content-center'>
                                            <a href='remove.php?removesupplier=$supplier_id' class='text-muted'><i class='fas fa-times'></i></a>
                                        </div>
                                    </div>
                                    <hr class='my-4'>";
                                }
