...
<body>
        ...
        <div class="navTop">
            ...
            <div class="hamburger-menu">
                ...
                <ul class="menu__box">
                    ...
                    <a class="nav-link" href="">
                        <?php if(isset($_SESSION["username"])){echo "<a href='index.php?logout'><li><a class='menu__item' href='index.php?logout' name='logout' style='color: red;' >Log Out</a></li></a>";}else{echo"Welcome Guest";} ?></a>
                    </li>
                </ul>
            </div>
            ...
            <a class="icon" href="cart.php">
                <i class="fa fa-shopping-cart cart1"
                    ...
                    <span
                        style="font-size: 14px; position: absolute; top: -8px; left: -12px; background-color: red; color: white; border-radius: 50%; padding: 2px 5px;"><?php echo getCartItemCount(); ?></span>
                </i>
            </a>
        </div>
    ...
    <div class="product" id="product">
        ...
        <div class="productDetails">
            ...
            <p class="productDesc">From musicians to artists to streetwear icons, the Air Force 1 has always been more
                than a sneaker. Everywhere it's gone, it's changed the game. But the past 40 years are behind us, so
                let's set the stage for the next 40. Because Force has always been strongest when we do it together.</p>
            <div class="colors">
                <div class="color"></div>
                <div class="color"></div>
            </div>
            ...
            <button class="productButton" onclick="openContainer()">BUY NOW!</button>
            <a href=" product_airforce.php">
                <EXPLORE class="productButton">EXPLORE
                    </button>
            </a>
        </div>


        <div class="payment" style="max-height:100%; overflow:auto; border:1px solid red; z-index:50;">
            <div class="container"
                style="background-color: aliceblue; max-width: 500px; padding: 20px; position: relative;">
                <a class="go-back-link" href="#" onclick="history.back();"><i class="bi bi-arrow-left-square"></i> Go
                    back</a>
                <div class="qr">
            ...
            ?>
                    ...
                    <div class="form-floating mt-5 mb-2">
                        <input type="text" class="form-control" id="tid" name="tid" minlength="12" maxlength="45"
                            required>
                    ...
                    <div class="form-floating">
                        <div class="mb-2 form-check">
                            ...
                            <label class="form-check-label small" for="tandc">I agree to the terms and conditions and
                                the
    ...
    <div class="gallery">
        ...
        <div class="galleryItem">
            <img src="https://i.postimg.cc/L5VZKnt0/a100f12f5f1a366107426676099e20b9.jpg" alt="" class="galleryImg">
            <h1 class="galleryTitle">This is the First Day of Your New Life</h1>
        </div>
        <div class="galleryItem">
            <h1 class="galleryTitle">Just Do it!</h1>
            <img src="https://i.postimg.cc/K4XtFdwR/sneaker-4687823-640.jpg" alt="" class="galleryImg">
        </div>
    </div>
    <div class="newSeason">
        <div class="nsItem">
        ...
        <div class="nsItem">
            <img src="https://i.postimg.cc/bwVNtQYR/people-wearing-0.png" alt="" class="nsImg">
        </div>
    </div>
